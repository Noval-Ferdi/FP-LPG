...
<body class="bg-white text-black">
    ...
    <section class="max-w-4xl mx-auto mt-12 px-6 text-gray-900 text-base md:text-lg leading-relaxed space-y-6">
        <p>
            ELPIJI Gas 3 kg hadir untuk memenuhi kebutuhan anda memasak masakan 
            untuk keluarga besar tercinta dirumah (lebih dari 4 orang anggota keluarga).
        </p>
        <p>
            ELPIJI Gas 3 kg merupakan produk LPG (Liquified Petroleum Gas) Subsidi dari PT.
            PERTAMINA (Persero) yang dikemas dalam tabung (berat tabung 8 kg).
        </p>
    </section>
