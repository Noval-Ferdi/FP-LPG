...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <header class="bg-white shadow rounded-b-2xl px-6 py-4 flex items-center gap-10">
        <img alt="Elpiji flame logo with text Elpiji" class="w-10 h-10 object-contain" height="40" src="../images/ELPIJI_1.png"
            width="40" />
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="bg-white w-64 flex flex-col justify-between py-10 px-6 rounded-r-3xl select-none">
            <nav class="flex flex-col gap-6 text-gray-400 text-base font-normal">
                ...
                <a aria-current="page" class="flex items-center gap-3 text-indigo-700 font-semibold" href="account.php">
                    <i class="fas fa-user text-indigo-700">
                    </i>
                    Akun
                </a>
        ...
        <main class="flex-1 p-8 overflow-auto max-w-4xl mx-auto">
            ...
            <section class="bg-white rounded-xl p-8 shadow-sm">
                <form class="flex flex-col gap-6 max-w-lg">
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2" for="companyName">
                            Company Name
                        </label>
                        <input
                            class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-600"
                            id="companyName" placeholder="PT. BEST" type="text" value="PT. BEST" />
                    </div>
                    <div>
                        ...
                        <input
                            class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-600"
                            id="email" placeholder="contact@ptbest.com" type="email" value="contact@ptbest.com" />
                    </div>
                    <div>
                        ...
                        <input
                            class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-600"
                            id="phone" placeholder="+62 812 3456 7890" type="tel" value="+62 812 3456 7890" />
                    </div>
                    <div>
                        ...
                        <textarea
                            ...
                            id="address" placeholder="Jl. Merdeka No. 123, Jakarta"
                            rows="3">Jl. Merdeka No. 123, Jakarta</textarea>
                    </div>
                    <button
