    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="bg-white w-64 flex flex-col justify-between py-10 px-6 rounded-r-3xl select-none">
            <nav class="flex flex-col gap-6 text-gray-400 text-base font-normal">
                ...
                <a aria-current="page" class="flex items-center gap-3 text-indigo-700 font-semibold" href="setting.php">
                    <i class="fas fa-cog text-indigo-700">
                    </i>
                    Setting
                </a>
            </nav>
        ...
        <main class="flex-1 p-8 overflow-auto max-w-4xl mx-auto">
            ...
            <section class="bg-white rounded-xl p-8 shadow-sm max-w-lg">
                <form class="flex flex-col gap-6">
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2" for="language">
                            Language
                        </label>
                        <select
                    ...
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2" for="timezone">
                            Timezone
                        </label>
                        <select
                            class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-600"
                    ...
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2" for="notifications">
                            Notifications
                        </label>
                        <div class="flex items-center gap-4">
                            <label class="inline-flex items-center">
                                <input checked="" class="form-checkbox h-5 w-5 text-indigo-600" type="checkbox" />
