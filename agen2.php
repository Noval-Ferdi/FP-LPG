...
<body class="font-sans text-black bg-white">
    ...
    <!-- Info bar -->
    <div class="bg-sky-300 text-sky-900 text-xs max-w-7xl mx-auto px-6 py-2">
        <span class="inline-flex items-center space-x-1">
            ...
            <span>
                ...
                <span class="font-semibold">
                    isi terlebih dahulu, untuk alamat dan lokasimu
                </span>
            </span>
        </span>
    </div>
    ...
    <div class="max-w-screen-xl mx-auto px-4 mt-4">
        ...
        <div class="mt-4">
            <input
                class="text-center max-w-md mx-auto block border border-gray-400 rounded-md py-2 px-4 text-xs placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600"
    ...
    <div class="max-w-7xl mx-auto px-6 mb-10">
        ...
        <p class="flex items-start space-x-3 mb-3 text-sm leading-5">
            <i class="fas fa-map-marker-alt mt-1">
            </i>
            <span>
                JALAN KEBONSARI JT III / 462 RT 029 RW 007, KELURAHAN GOWONGAN, KECAMATAN
                JETIS, KOTA YOGYAKARTA
            </span>
        </p>
        <p class="flex items-center space-x-3 text-sm leading-5">
    ...
    <hr class="border-gray-400 max-w-7xl mx-auto" />
    <!-- Footer -->
